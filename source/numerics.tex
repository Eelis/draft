...
\tcode{complex<long double>} are \deflinkx{literal types}{type!literal}{basic.types}.
...
\deflinkx{value-initialized}{value-initialization}{dcl.init}; the third element of the result will be assigned the value
