...
\deflinkx{value representation}{representation!value}{basic.types} of \tcode{unsigned long long}.
...
\indexlibrarymember{release}{synchronized_pool_resource}\indexlibrarymember{release}{unsynchronized_pool_resource}%
\begin{itemdecl}
void release();
\end{itemdecl}
...
Every \deflink{call wrapper}{func.def} meets the \oldconcept{MoveConstructible}
...
\link{expression-equivalent}{defns.expression-equivalent} to
...
\pnum
\returns
\indexlink{\tcode{\placeholder{INVOKE}}}{libraryindex}{invoke@\tcode{\placeholder{INVOKE}}}{func.require}%
...
\deflinkx{trivially copyable type}{type!trivially copyable}{basic.types}.
...
and call arbitrary \deflinkx{callable objects}{object!callable}{func.def}, given a
\deflink{call signature}{func.def}, allowing functions to be first-class objects.

\pnum
\indextext{callable type}%
A \deflinkx{callable type}{type!callable}{func.def} \tcode{F}
...
\indexlibrary{\idxcode{function}!invocation}\indexlibrarymember{operator()}{function}%
\begin{itemdecl}
...
namespace std {
  ...
  template<size_t Len, size_t Align = @\textit{default-alignment}@> // see \ref{meta.trans.other}
    using @\libglobal{aligned_storage_t}@  = typename @\libglobalref{aligned_storage}@<Len, Align>::type;
  template<size_t Len, class... Types>
    using @\libglobal{aligned_union_t}@    = typename @\libglobalref{aligned_union}@<Len, Types...>::type;
  template<class T>
  ...
  template<class T>
    using unwrap_reference_t = typename @\libglobalref{unwrap_reference}@<T>::type;
  template<class T>
    using unwrap_ref_decay_t = typename @\libglobalref{unwrap_ref_decay}@<T>::type;
  template<class...>
  ...
  // \ref{meta.unary.cat}, primary type categories
  template<class T>
    inline constexpr bool @\libglobal{is_void_v}@ = @\libglobalref{is_void}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_null_pointer_v}@ = @\libglobalref{is_null_pointer}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_integral_v}@ = @\libglobalref{is_integral}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_floating_point_v}@ = @\libglobalref{is_floating_point}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_array_v}@ = @\libglobalref{is_array}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_pointer_v}@ = @\libglobalref{is_pointer}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_lvalue_reference_v}@ = @\libglobalref{is_lvalue_reference}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_rvalue_reference_v}@ = @\libglobalref{is_rvalue_reference}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_member_object_pointer_v}@ = @\libglobalref{is_member_object_pointer}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_member_function_pointer_v}@ = @\libglobalref{is_member_function_pointer}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_enum_v}@ = @\libglobalref{is_enum}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_union_v}@ = @\libglobalref{is_union}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_class_v}@ = @\libglobalref{is_class}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_function_v}@ = @\libglobalref{is_function}@<T>::value;

  // \ref{meta.unary.comp}, composite type categories
  template<class T>
    inline constexpr bool @\libglobal{is_reference_v}@ = @\libglobalref{is_reference}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_arithmetic_v}@ = @\libglobalref{is_arithmetic}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_fundamental_v}@ = @\libglobalref{is_fundamental}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_object_v}@ = @\libglobalref{is_object}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_scalar_v}@ = @\libglobalref{is_scalar}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_compound_v}@ = @\libglobalref{is_compound}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_member_pointer_v}@ = @\libglobalref{is_member_pointer}@<T>::value;

  // \ref{meta.unary.prop}, type properties
  template<class T>
    inline constexpr bool @\libglobal{is_const_v}@ = @\libglobalref{is_const}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_volatile_v}@ = @\libglobalref{is_volatile}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_trivial_v}@ = @\libglobalref{is_trivial}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_trivially_copyable_v}@ = @\libglobalref{is_trivially_copyable}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_standard_layout_v}@ = @\libglobalref{is_standard_layout}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_empty_v}@ = is_empty<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_polymorphic_v}@ = @\libglobalref{is_polymorphic}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_abstract_v}@ = @\libglobalref{is_abstract}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_final_v}@ = @\libglobalref{is_final}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_aggregate_v}@ = @\libglobalref{is_aggregate}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_signed_v}@ = is_signed<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_unsigned_v}@ = @\libglobalref{is_unsigned}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_bounded_array_v}@ = @\libglobalref{is_bounded_array}@<T>::value;
  template<class T>
  ...
  template<class T, class... Args>
    inline constexpr bool @\libglobal{is_constructible_v}@ = @\libglobalref{is_constructible}@<T, Args...>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_default_constructible_v}@ = @\libglobalref{is_default_constructible}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_copy_constructible_v}@ = @\libglobalref{is_copy_constructible}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_move_constructible_v}@ = @\libglobalref{is_move_constructible}@<T>::value;
  template<class T, class U>
    inline constexpr bool @\libglobal{is_assignable_v}@ = @\libglobalref{is_assignable}@<T, U>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_copy_assignable_v}@ = @\libglobalref{is_copy_assignable}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_move_assignable_v}@ = @\libglobalref{is_move_assignable}@<T>::value;
  template<class T, class U>
    inline constexpr bool @\libglobal{is_swappable_with_v}@ = @\libglobalref{is_swappable_with}@<T, U>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_swappable_v}@ = @\libglobalref{is_swappable}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_destructible_v}@ = @\libglobalref{is_destructible}@<T>::value;
  template<class T, class... Args>
  ...
  template<class T, class U>
    inline constexpr bool @\libglobal{is_trivially_assignable_v}@ = @\libglobalref{is_trivially_assignable}@<T, U>::value;
  template<class T>
  ...
  template<class T>
    inline constexpr bool @\libglobal{is_trivially_destructible_v}@ = @\libglobalref{is_trivially_destructible}@<T>::value;
  template<class T, class... Args>
  ...
  template<class T, class U>
    inline constexpr bool @\libglobal{is_nothrow_assignable_v}@ = @\libglobalref{is_nothrow_assignable}@<T, U>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_nothrow_copy_assignable_v}@ = @\libglobalref{is_nothrow_copy_assignable}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_nothrow_move_assignable_v}@ = @\libglobalref{is_nothrow_move_assignable}@<T>::value;
  template<class T, class U>
    inline constexpr bool @\libglobal{is_nothrow_swappable_with_v}@ = @\libglobalref{is_nothrow_swappable_with}@<T, U>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_nothrow_swappable_v}@ = @\libglobalref{is_nothrow_swappable}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{is_nothrow_destructible_v}@ = @\libglobalref{is_nothrow_destructible}@<T>::value;
  template<class T>
    inline constexpr bool @\libglobal{has_virtual_destructor_v}@ = @\libglobalref{has_virtual_destructor}@<T>::value;
  template<class T>
  ...
  // \ref{meta.unary.prop.query}, type property queries
  template<class T>
    inline constexpr size_t @\libglobal{alignment_of_v}@ = @\libglobalref{alignment_of}@<T>::value;
  template<class T>
    inline constexpr size_t @\libglobal{rank_v}@ = @\libglobalref{rank}@<T>::value;
  template<class T, unsigned I = 0>
    inline constexpr size_t @\libglobal{extent_v}@ = @\libglobalref{extent}@<T, I>::value;

  // \ref{meta.rel}, type relations
  template<class T, class U>
    inline constexpr bool @\libglobal{is_same_v}@ = @\libglobalref{is_same}@<T, U>::value;
  template<class Base, class Derived>
    inline constexpr bool @\libglobal{is_base_of_v}@ = @\libglobalref{is_base_of}@<Base, Derived>::value;
  template<class From, class To>
    inline constexpr bool @\libglobal{is_convertible_v}@ = @\libglobalref{is_convertible}@<From, To>::value;
  template<class From, class To>
    inline constexpr bool @\libglobal{is_nothrow_convertible_v}@ = @\libglobalref{is_nothrow_convertible}@<From, To>::value;
  template<class T, class U>
    inline constexpr bool @\libglobal{is_layout_compatible_v}@ = @\libglobalref{is_layout_compatible}@<T, U>::value;
  template<class Base, class Derived>
  ...
  template<class Fn, class... ArgTypes>
    inline constexpr bool @\libglobal{is_invocable_v}@ = @\libglobalref{is_invocable}@<Fn, ArgTypes...>::value;
  template<class R, class Fn, class... ArgTypes>
    inline constexpr bool @\libglobal{is_invocable_r_v}@ = @\libglobalref{is_invocable_r}@<R, Fn, ArgTypes...>::value;
  template<class Fn, class... ArgTypes>
    inline constexpr bool @\libglobal{is_nothrow_invocable_v}@ = @\libglobalref{is_nothrow_invocable}@<Fn, ArgTypes...>::value;
  template<class R, class Fn, class... ArgTypes>
  ...
  // \ref{meta.logical}, logical operator traits
  template<class... B>
    inline constexpr bool @\libglobal{conjunction_v}@ = @\libglobalref{conjunction}@<B...>::value;
  template<class... B>
    inline constexpr bool @\libglobal{disjunction_v}@ = @\libglobalref{disjunction}@<B...>::value;
  template<class B>
    inline constexpr bool @\libglobal{negation_v}@ = @\libglobalref{negation}@<B>::value;
...
\tcode{template<class T>}\br
 ...
 \deflinkx{signed integer type}{type!signed integer}{basic.fundamental} then the member typedef
...
\tcode{template<class T>}\br
 ...
 If \tcode{T} names a (possibly cv-qualified)
 \deflinkx{unsigned integer type}{type!unsigned integer}{basic.fundamental} then the member typedef
 \tcode{type} names the type \tcode{T}; otherwise,
...
\pnum
\begin{note}
A typical implementation would define \libglobal{aligned_storage} as:
\begin{codeblock}
...
\begin{itemize}
\item \noncxxtcode{U+1100-U+115F}
\item \noncxxtcode{U+2329-U+232A}
\item \noncxxtcode{U+2E80-U+303E}
\item \noncxxtcode{U+3040-U+A4CF}
\item \noncxxtcode{U+AC00-U+D7A3}
\item \noncxxtcode{U+F900-U+FAFF}
\item \noncxxtcode{U+FE10-U+FE19}
\item \noncxxtcode{U+FE30-U+FE6F}
\item \noncxxtcode{U+FF00-U+FF60}
\item \noncxxtcode{U+FFE0-U+FFE6}
\item \noncxxtcode{U+1F300-U+1F64F}
\item \noncxxtcode{U+1F900-U+1F9FF}
\item \noncxxtcode{U+20000-U+2FFFD}
\item \noncxxtcode{U+30000-U+3FFFD}
\end{itemize}
...
arithmetic types other than \tcode{charT} and \tcode{bool}
or when an integer presentation type is specified.
If the \noncxxtcode{0} character and an \fmtgrammarterm{align} option both appear,
the \noncxxtcode{0} character is ignored.
\begin{example}
\begin{codeblock}
char c = 120;
...
\end{codeblock}
with the prefix \noncxxtcode{0x} added to the output;
