...
\end{outputblock}
where \noncxxtcode{<Start>} has the XID_Start property,
\noncxxtcode{<Continue>} has the XID_Continue property, and
\noncxxtcode{<Medial>} is a list of characters permitted between continue characters.
