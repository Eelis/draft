...
\libmemberrefx{allocator_traits<allocator_type>::rebind_traits<U>::\brk{}construct}{allocator_traits}{construct}
and destroyed using the function
\libmemberrefx{allocator_traits<allocator_type>::rebind_traits<U>::\brk{}destroy}{allocator_traits}{destroy},
...
\pnum
\remarks
\link{Stable}{algorithm.stable}. If \tcode{addressof(x) != this}, the range \range{x.begin()}{x.end()}
